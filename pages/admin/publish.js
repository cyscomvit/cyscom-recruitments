...
export default function Admin() {
    ...
    return (
        <div style={{ 
            ...
            minHeight: '92.5vh',
            paddingTop: '70px' }} >
            {loading ? <div>Loading...</div> : value.state.user && value.state.isAdmin ? <><PubResultComp onSubmit = {handlePublish} allEmails={docs}></PubResultComp><ViewSelected></ViewSelected></> : <div>Not Found</div>}
        </div>
    )
}
