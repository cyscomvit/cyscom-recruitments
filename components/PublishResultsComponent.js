...
const PubResultComp = ({ onSubmit, allEmails }) => {
  ...
  return (
    <div style={{ paddingTop: '5rem' }}>
      {submitting ? (
        <Alert
          message={'Publishing Results.. Click Refresh to see changes'}
          type='info'
        ></Alert>
      ) : null}
              ...
              {fields.map(({ key, name, ...restField }) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Option value='Development (Web-Dev and Open Source Projects)'>
                        Development (Web-Dev and Open Source Projects)
                      </Option>
                      <Option value='Technical (CTF and Projects)'>
      ...
      >
        ...
        >
          Final Publish ! ! ! Caution that this will reject all candidates who
          have not been selected already.
        </Button>
      </div>
    </div>
  );
